...
export const fr_FR: typeof zh_CN = {
  ...
  SCANNING_FILES:
    "Vérification de l’intégrité des fichiers de jeu. Fichiers terminés {0}/{1}{2}",
  ...
  INITIALIZING_SOPHON_RETRY: en.INITIALIZING_SOPHON_RETRY,
  ...
  INITIALIZING_VERIFYING_STATE: en.INITIALIZING_VERIFYING_STATE,
  INITIALIZING_REVERTING_PATCHES: en.INITIALIZING_REVERTING_PATCHES,
  INITIALIZING_RESTORING_FILES: en.INITIALIZING_RESTORING_FILES,
  INITIALIZING_REMOVING_FILES: en.INITIALIZING_REMOVING_FILES,
  INITIALIZING_REVERTING_GRAPHICS: en.INITIALIZING_REVERTING_GRAPHICS,
  INITIALIZING_READING_MANIFEST: en.INITIALIZING_READING_MANIFEST,
  INITIALIZING_SCANNING_FILES: en.INITIALIZING_SCANNING_FILES,
  INITIALIZING_VERIFYING_CHECKSUMS: en.INITIALIZING_VERIFYING_CHECKSUMS,
  INITIALIZING_FIXING_CORRUPTED: en.INITIALIZING_FIXING_CORRUPTED,
  ...
  SETTING_METALFX_SPATIAL: "Mise à l'échelle spatiale MetalFX",
  SETTING_METALFX_SPATIAL_DESC:
    "Rend le jeu à une résolution interne inférieure et upscale avec MetalFX. Utile uniquement sur écrans Retina.",
  SETTING_METALFX_SPATIAL_OFF: "Désactivé (natif)",
  SETTING_METALFX_SPATIAL_QUALITY: "Qualité (1.3x)",
  SETTING_METALFX_SPATIAL_BALANCE: "Équilibré (1.5x)",
  SETTING_METALFX_SPATIAL_PERFORMANCE: "Performance (2.0x)",
  SETTING_RETINA: "Mode Retina",
  SETTING_LEFT_CMD: "Mapper CMD gauche à CTRL",
  SETTING_CAPTURE_DISPLAYS_FULLSCREEN: "Capturer les écrans en plein écran",
  SETTING_CAPTURE_DISPLAYS_FULLSCREEN_DESC:
    "Force le jeu à utiliser le chemin de présentation Direct de macOS pour que Metal contourne la composition WindowServer. Réduit la latence et évite les retours Direct→Composited, mais désactive la barre de menu et les écrans auxiliaires pendant le jeu.",
  SETTING_LOGGING_SESSION: "Journalisation de débogage",
  SETTING_LOGGING_SESSION_OFF: "Désactivé",
  SETTING_LOGGING_SESSION_BASIC: "Basique (unified log)",
  SETTING_LOGGING_SESSION_DEEP: "Approfondie (unified log + trace Instruments)",
  SETTING_LOGGING_SESSION_DESC:
    "Enregistre une trace de chaque session de jeu dans logs/sessions/. Basique utilise le unified logging de macOS (Metal, CoreAnimation, WindowServer, Wine) avec un surcoût quasi nul. Approfondie ajoute une trace 'Game Performance' de Xcode Instruments (~100–300 Mo par minute ; requiert Xcode).",
