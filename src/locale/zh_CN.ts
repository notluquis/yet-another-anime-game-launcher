...
export const zh_CN = {
  ...
  DOWNLOADING_FILE_PROGRESS: "正在下载游戏文件：{0} ({2}/{3}) {1}/s",
  ...
  SETTING_METALFX_SPATIAL: "MetalFX 空间放大",
  SETTING_METALFX_SPATIAL_DESC:
    "以较低内部分辨率渲染并使用 MetalFX 放大。仅在 Retina 屏幕上有意义。",
  SETTING_METALFX_SPATIAL_OFF: "关闭（原生）",
  SETTING_METALFX_SPATIAL_QUALITY: "质量 (1.3x)",
  SETTING_METALFX_SPATIAL_BALANCE: "平衡 (1.5x)",
